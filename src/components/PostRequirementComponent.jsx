...
class PostRequirementComponent extends Component {
    ...
    componentDidMount(){
      ...
      this.setState({frontendList:[{value:'HTML', label:'HTML'}, {value:'CSS', label:'CSS'}, {value:'JavaScript', label:'JavaScript'}, {value:'Bootstrap', label:'Bootstrap'}, {value:'AngularJs', label:'AngularJs'},  {value:'ReactJs', label:'ReactJs'},  {value:'Vue.js', label:'Vue.js'},  {value:'Flutter', label:'Flutter'},  {value:'Ionic', label:'Ionic'}]}); 
      this.setState({backendList:[{value:'C#', label:'C#'}, {value:'Java', label:'Java'},{value:'Python', label:'Python'}, {value:'SpringBoot', label:'SpringBoot'}, {value:'NodeJS', label:'NodeJS'}, {value:'PHP', label:'PHP'}, {value:'Django', label:'Django'}, {value:'Maven', label:'Maven'}]});
      ...
      this.setState({manualTestingList:[{value:'Apache Jmeter', label:'Apache Jmeter'}, {value:'Loadrunner', label:'Loadrunner'}, {value:'TestLink', label:'TestLink'}, {value:'QTP', label:'QTP'}]})
      this.setState({automaticTestingList:[{value:'Selenium', label:'Selenium'}, {value:'Jira', label:'Jira'}, {value:'Junit', label:'Junit'}, {value:'HP – UFT', label:'HP – UFT'}, {value:'SoapUI', label:'SoapUI'}, {value:'Appium', label:'Appium'} ]})

      this.setState({bAList:[{value:'Academic Business Analysis Certificate (ABAC)', label:'Academic Business Analysis Certificate (ABAC)'}, 
      {value:'IIBA Entry Certificate in business analysis (ECBA)', label:'IIBA Entry Certificate in business analysis (ECBA)'}, 
      {value:'IIBA Certification of competency in business analysis (CCBA)', label:'IIBA Certification of competency in business analysis (CCBA)'}, 
      {value:'IQBBA Certified foundation level business analyst(CFLBA)', label:'IQBBA Certified foundation level business analyst(CFLBA)'}]})

      this.setState({managerTechList:[{value:'AMA Certified Professional in Management', label:'AMA Certified Professional in Management'}, 
      {value:'Certified Associate in Project Management (CAPM)', label:'Certified Associate in Project Management (CAPM)'}, 
      {value:'Certified ScrumMaster (CSM)', label:'Certified ScrumMaster (CSM)'}, 
      {value:'Certified Information Security Manager (CISM)', label:'Certified Information Security Manager (CISM)'}, 
      {value:'CompTIA Project+', label:'CompTIA Project+'}]})
    }
    ...
    selectJobRoleType(e){
      ...
      switch(e.target.value){
          ...
          case 'Database Developer':
              ...
              break;
          case 'Manual Testing':
                  for(var i of this.state.manualTestingList) {
                      this.state.DDL4.push(i);
                  }
                  break;
          case 'Automatic Testing':
                      for(var i of this.state.automaticTestingList) {
                          this.state.DDL4.push(i);
                      }
                      break;
          case 'Bussiness Analyst':
              for(var i of this.state.bAList) {
                  this.state.DDL4.push(i);
              }
              break;
          case 'Bussiness Analyst':
